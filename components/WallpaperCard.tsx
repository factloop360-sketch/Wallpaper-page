  ...
  return (
    <>
      ...
      >
        ...
        <div className={`absolute inset-0 bg-black/20 opacity-0 transition-opacity duration-300 pointer-events-none ${isLoaded ? 'group-hover:opacity-100' : ''}`} aria-hidden="true" />
        <div className={`absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-black/90 via-black/40 to-transparent opacity-0 transition-opacity duration-300 pointer-events-none ${isLoaded ? 'group-hover:opacity-100' : ''}`} aria-hidden="true" />
        ...
        <div className="absolute inset-0 p-4 flex flex-col justify-between opacity-0 group-hover:opacity-100 transition-all duration-300 ease-out z-10">
          ...
          <div className="flex items-end justify-between gap-3 translate-y-[10px] group-hover:translate-y-0 transition-transform duration-300 ease-[cubic-bezier(0.25,1,0.5,1)]">
            <div>
            ...
            <button 
              className="p-2.5 bg-white text-black hover:bg-zinc-200 rounded-full transition-all flex-shrink-0 scale-95 hover:scale-105 active:scale-90"
